...
project = u'spectrogrism'
copyright = u'2016, Yannick Copin <y.copin(at)ipnl.in2p3.fr>'
author = u'Yannick Copin'
...
htmlhelp_basename = 'spectrogrismdoc'
...
latex_documents = [
    (master_doc, 'spectroGrism.tex', u'SpectroGrism Documentation',
     author, 'manual'),
]
...
man_pages = [(master_doc, project, u'SpectroGrism Documentation',
              [author], 1)]
...
texinfo_documents = [(master_doc, project, u'SpectroGrism Documentation',
                      author, project,
